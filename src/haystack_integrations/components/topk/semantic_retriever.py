...
@component
class TopKSemanticRetriever:
    """
    Retriever that performs semantic search against a TopKDocumentStore - no embedder component needed.
    """
    ...
    def run(
        ...
        """
        Run a server-side semantic similarity search. No embedder component needed.
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TopKSemanticRetriever":
